...
//  Tapestry
//
//  Created by suleyu on 15/7/8.
//  Copyright (c) 2015年 Kortide. All rights reserved.
//

#ifndef Tapestry_CH264_RTP_UNPACK_h
#define Tapestry_CH264_RTP_UNPACK_h
...
public:
    ...
    CH264_RTP_UNPACK ( int &error, unsigned char H264PAYLOADTYPE = 96 )
    : m_bSPSFound(false)
